...
const i18n = {
  id: {
    ...
    filterVesselName: "Semua Nama Kapal",
    filterStatus: "Semua Status Operasional",
    statusOnBoat: "ON_BOAT (Di Atas Kapal)",
    statusSelected: "SELECTED (Terpilih)",
    statusStandBy: "STAND_BY (Stand By)",
    statusOnBoatSelected: "ON_BOAT & SELECTED",
    themeDarkGlass: "🌌 Dark Ocean Transparan",
    themeLightCrystal: "☀️ Light Crystal Transparan",
    themeCyber: "💜 Cyberpunk Transparan",
    themeEmerald: "🌲 Emerald Glass Transparan",
    themeSlate: "🔲 Slate Transparan",
    themeDarkVibrant: "🔥 Dark Vibrant Transparan",
  ...
  zh: {
    ...
    filterQual: "所有延绳钓经验",
    filterVessel: "所有船舶类型",
    filterVesselName: "所有船名",
    filterStatus: "所有状态",
    statusOnBoat: "ON_BOAT (在船)",
    statusSelected: "SELECTED (已选中)",
    statusStandBy: "STAND_BY (待命)",
    statusOnBoatSelected: "ON_BOAT 与 SELECTED",
    themeDarkGlass: "🌌 深海透明 (Dark Glass)",
    themeLightCrystal: "☀️ 水晶白透明 (Light Crystal)",
    themeCyber: "💜 赛博朋克透明 (Cyberpunk)",
    themeEmerald: "🌲 翡翠绿透明 (Emerald Glass)",
    themeSlate: "🔲 石墨灰透明 (Slate Glass)",
    themeDarkVibrant: "🔥 炫彩暗黑透明 (Dark Vibrant)",
    addToBasket: "加入选船篮",
    inBasket: "已在选船篮中",
