...
const i18n = {
  id: {
    ...
    lblRankPosition: "Jabatan",
    lblContact: "Kontak",
    lblScoreComm: "Komunikasi",
    lblScoreSkill: "Skill / Teknik",
    lblScoreExp: "Pengalaman",
    lblScoreAttitude: "Sikap",
    lblScoreLeadership: "Kepemimpinan",
    lblInterviewNotes: "Catatan Wawancara",
    phInterviewNotes: "Tambahkan catatan wawancara di sini...",
    lblSelectionStatus: "Status Seleksi",
    btnWaiting: "Menunggu",
    btnSelected: "Terpilih",
    btnPriority: "Prioritas",
    btnRejected: "Ditolak",
    btnSaveReview: "Simpan Review & Keputusan",
    docPhoto: "Foto",
    docPassport: "Paspor",
    docCdc: "Buku Pelaut",
    docMedical: "MCU",
  ...
  zh: {
    ...
    lblScoreExp: "经验",
    lblScoreAttitude: "态度",
    lblScoreLeadership: "领导力",
    lblInterviewNotes: "面试笔记",
    phInterviewNotes: "在此添加面试笔记...",
    lblSelectionStatus: "选择状态",
    btnWaiting: "等待",
    btnSelected: "已选",
    btnPriority: "优先",
    btnRejected: "拒绝",
    btnSaveReview: "保存审查和决定",
    docPhoto: "照片",
    docPassport: "护照",
    docCdc: "海员证",
    docMedical: "体检",
  ...
  en: {
    appTitle: "Longline Crew Data & Catalog System",
    appSubtitle: "Wantaifeng International Co Ltd - PT ALINDA PRIMA SENTOSA",
    langID: "Bahasa Indonesia",
    langZH: "繁體中文 (Traditional Chinese)",
    langEN: "English",
    
    catalogTitle: "Longline Fishing Vessel Crew Selection Catalog",
    catalogDesc: "Selecting Quality Indonesian Crew for Taiwan & Foreign Longline Vessels",
    searchPlaceholder: "Search name, position, vessel...",
    filterRank: "All Positions",
    filterQual: "All Longline Qualifications",
    filterVessel: "All Vessel Types",
    addToBasket: "Add to Basket",
    inBasket: "In Basket",
    basketTitle: "Crew Selection Basket",
    basketCount: "Selected Crew",
    checkoutBooking: "Submit Booking Request",
    
    revCandidateInfo: "Candidate Information",
    lblFullName: "Full Name",
    lblDob: "Date of Birth",
    lblHeight: "Height",
    lblWeight: "Weight",
    lblExperience: "Experience",
    lblLastVessel: "Last Vessel",
    lblDocStatus: "Document Status",
    lblInterviewScore: "Interview Scores",
    lblRankPosition: "Position",
    lblContact: "Contact",
    lblScoreComm: "Communication",
    lblScoreSkill: "Technical Skill",
    lblScoreExp: "Experience",
    lblScoreAttitude: "Attitude",
    lblScoreLeadership: "Leadership",
    lblInterviewNotes: "Interview Notes",
    phInterviewNotes: "Add interview notes here...",
    lblSelectionStatus: "Selection Status",
    btnWaiting: "Waiting",
    btnSelected: "Selected",
    btnPriority: "Priority",
    btnRejected: "Rejected",
    btnSaveReview: "Save Review & Decision",
    docPhoto: "Photo",
    docPassport: "Passport",
    docCdc: "Seaman Book",
    docMedical: "Medical (MCU)"
  }
};
